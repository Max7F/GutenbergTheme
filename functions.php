...
function register_my_menus(){
    register_nav_menus (
        array('header-menu' => 'header-menu1', 'footer-menu' => 'footer-menu1','footer-services' => 'footer-menu2')
    );
}
...
function stars_reviews($a) {
    $stars = $a;
    if (preg_match('/^\+?\d+$/', $stars)) {
        if ($stars == 0) {
            echo '<em>Not rated</em>';
        } else {
            for ($i = 0; $i < $stars; $i++) {
                echo '<img src="/wp-content/themes/7fridays-gutenberg-theme-main/images/full-star.svg" style="width: 17px">';
            }
        }
        //empty
        if ($stars != 0) {
            for ($i = $stars; $i <= 4; $i++) {
                echo '<img src="/wp-content/themes/7fridays-gutenberg-theme-main/images/star-empty.svg" style="width: 20px">';
            }
        }
    } else {
        $starsFull = ceil($stars);
        if ($stars == 0) {
            echo '<em>Not rated</em>';
        } else {
            ...
            echo '<img src="/wp-content/themes/7fridays-gutenberg-theme-main/images/star-half.svg" style="width: 18px">';
            //empty
            for ($i = $stars; $i <= 4; $i++) {
                echo '<img src="/wp-content/themes/7fridays-gutenberg-theme-main/images/star-empty.svg" style="width: 20px">';
            }
